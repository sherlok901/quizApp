...
function btn1::OnClick() 					{ Menu.OnEvent("1"); }
function btn2::OnClick() 					{ Menu.OnEvent("2"); }
function btn3::OnClick() 					{ Menu.OnEvent("3"); }
function btn4::OnClick() 					{ Menu.OnEvent("4"); }
function btn5::OnClick() 					{ Menu.OnEvent("5"); }
function btn6::OnClick() 					{ Menu.OnEvent("6"); }
function btn7::OnClick() 					{ Menu.OnEvent("7"); }
function btn8::OnClick() 					{ Menu.OnEvent("8"); }
function btn9::OnClick() 					{ Menu.OnEvent("9"); }
function btn0::OnClick() 					{ Menu.OnEvent("0"); }

function btnDot::OnClick() 					{ Menu.OnEvent("dot"); }
function btnF::OnClick() 					{ Menu.OnEvent("f"); OnClickF(); }

function btnEnter::OnClick() 				{ Menu.OnEvent("enter"); }
function btnEsc::OnClick() 					{ Menu.OnEvent("esc"); }
